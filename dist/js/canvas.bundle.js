...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".play-game {\n    margin-left: 2px;\n    border: 1px solid black;\n    color: white;\n    background: darkolivegreen;\n    cursor: pointer;\n    border-radius: 4px;\n    transition: all 0.4s;\n}\n.play-game:hover {\n    transform: scale(1.04);\n}\n", "",{"version":3,"sources":["webpack://./src/styles/style.css"],"names":[],"mappings":"AAAA;IACI,gBAAgB;IAChB,uBAAuB;IACvB,YAAY;IACZ,0BAA0B;IAC1B,eAAe;IACf,kBAAkB;IAClB,oBAAoB;AACxB;AACA;IACI,sBAAsB;AAC1B","sourcesContent":[".play-game {\n    margin-left: 2px;\n    border: 1px solid black;\n    color: white;\n    background: darkolivegreen;\n    cursor: pointer;\n    border-radius: 4px;\n    transition: all 0.4s;\n}\n.play-game:hover {\n    transform: scale(1.04);\n}\n"],"sourceRoot":""}]);
// Exports
...
var paddleX = 30;
var relativeX = 0;
var paddleHeightY = canvas.height - 40;
var circleRadius = 30;
var x = Math.random() * canvas.width + circleRadius * 2;
var y = Math.random() + canvas.height / 2 + circleRadius * 2;
var dx;
var dy;
...
function GamePlay(x, y, radius) {
  ...
  this.update = function () {
    // dx and dy condition
    if (_this.x + _this.radius > canvas.width || _this.x + _this.radius < _this.radius * 2) {
      _this.dx = -_this.dx;
    }
    if (_this.y + _this.radius > canvas.height || _this.y + _this.radius < _this.radius * 2) {
      _this.dy = -_this.dy;
    }
    ...
    //this.dy = -3;
    //}
    if (_this.x > paddleX && _this.x < paddleX + paddleWidth && _this.y + _this.radius >= paddleHeightY) {
    ...
    _this.drawPlayerLine();
    _this.drawCircle();
  };
  this.drawPlayerLine = function () {
    // draw line
    c.beginPath();
  ...
  this.drawCircle = function () {
    // draw circle
    c.beginPath();
    c.arc(_this.x, _this.y, _this.radius, 0, Math.PI * 2);
    c.fillStyle = "red";
    c.fill();
    c.stroke();
  };
